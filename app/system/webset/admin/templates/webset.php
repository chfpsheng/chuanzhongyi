...
<div class="met-web-set">
    <form method="POST" action="{$url.own_name}c=info&a=doSaveInfo" data-submit-ajax="1" class='info-form'
        ...
        <div class="metadmin-fmbx">
            ...
            <h3 class='example-title'>备案信息设置</h3>
            <dl>
                <dt>
...
<!--            <dl>-->
<!--                <dt>-->
<!--                    <label class='form-control-label'>公安备案信息</label>-->
<!--                </dt>-->
<!--                <dd>-->
<!--                    <div class='form-group clearfix'>-->
<!--                        <textarea name="met_beian_info" rows="5" class="form-control met-scrollbar scrollbar-grey oya"></textarea>-->
<!--                    </div>-->
<!--                </dd>-->
<!--            </dl>-->
            ...
            <if value="$c['met_agents_metmsg'] eq '1'">
                <dl>
                    ...
                    <dd>
                        ...
                        <span class="text-help ml-2">{$word.copyright_type_tips1}<a href="https://www.metinfo.cn/metinfo/license.html" title="{$word.copyright_type_tips2}" target="_blank">{$word.copyright_type_tips2}</a>，{$word.copyright_type_tips3}“<a href="https://www.metinfo.cn/copyright/" title="{$word.copyright_type_tips4}" target="_blank">{$word.copyright_type_tips4}</a>”。</span>
                    </dd>
                </dl>
            </if>
