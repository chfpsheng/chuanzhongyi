...
<table class="table table-hover w-100 mt-2" id="about-list">
	...
	<tbody>
		...
		<tr>
			<td>{$a.name}</td>
			<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".about-details-modal" data-modal-title="{$word.editor}" data-modal-size="xl" data-modal-url="about/edit/?c=about_admin&a=doeditor&id={$a.id}" data-modal-fullheight="1">{$word.editor}</button></td>
		</tr>
		</list>
		<else/>
