...
$foot_save_no=1;
?>
<div class='text-danger'>{$word.admin_content_list1}</div>
<form action="javascript:;" class="form-inline">
  ...
  <table class="table table-hover dataTable w-100" id="user-para-options-list" data-plugin="checkAll">
    ...
    <include file="pub/content_list/tfoot_first"/>
          <button type="button" class="btn btn-light btn-para-delete-all">
            {$word.delete}
          </button>
          <button type="button" class="btn btn-outline-666 ml-1" table-addlist data-nocancel="1">
            {$word.add}
          </button>
          <textarea table-addlist-data hidden>
              <tr>
                ...
                <td><button type="button" class="btn btn-light btn-para-delete" >{$word.delete}</button></td>
                </tr>
          </textarea>
        </th>
      </tr>
