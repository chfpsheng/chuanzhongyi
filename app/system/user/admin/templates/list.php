...
<div class="met-user-list">
  <div class="clearfix">
    <button type="button" class="btn btn-outline-666 btn-add" data-toggle="modal" data-modal-url="user/user_add"
      ...
      <tr>
        ...
        <th colspan="8" data-no_column_defs class="btn_group">
          <div class="justify-content-between row m-0">
            <button type="button" class="btn btn-light px-4 btn-delete-all">
              {$word.delete}
            </button>
