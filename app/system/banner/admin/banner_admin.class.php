...
class banner_admin extends base_admin
{
    ...
    public function dojson_list()
    {
        ...
        foreach ($flashrec_list as $key => $val) {
            ...
            $list['img_title'] = htmlspecialchars($val['img_title'], ENT_QUOTES, 'UTF-8');
            ...
            if ($id) {
                switch ($_M['form']['submit_type']) {
                    case 'save':
                        ...
                        $this->_listSave($id, $list['no_order'], $list['height'], $list['height_t'], $list['height_m']);
                        break;
                    case 'del':
     ...
     * @return mixed
     */
    public function _listSave($id, $no_order, $height, $height_t, $height_m)
    {
        $list['id'] = $id;
    ...
    public function doeditor()
    {
        ...
        $banner['img_title'] = htmlspecialchars($banner['img_title'], ENT_QUOTES, 'UTF-8');
        $banner['img_title_mobile'] = htmlspecialchars($banner['img_title_mobile'], ENT_QUOTES, 'UTF-8');
        $banner['img_des'] = htmlspecialchars($banner['img_des'], ENT_QUOTES, 'UTF-8');
        $banner['img_des_mobile'] = htmlspecialchars($banner['img_des_mobile'], ENT_QUOTES, 'UTF-8');
