...
<div class="clearfix">
	<div class="float-left">
		<button type="button" class="btn btn-outline-666 btn-banner-list-add" data-toggle="modal" data-target=".banner-add-modal" data-modal-title="{$word.indexflashaddflash}" data-modal-size="xl" data-modal-url="banner/edit/?c=banner_admin&a=doadd" data-modal-fullheight="1" data-modal-height100="1" data-modal-tablerefresh="#{$table_order}">{$word.indexflashaddflash}</button>
	</div>
