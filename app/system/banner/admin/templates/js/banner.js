								...
								if(result.data){
									...
									$.each(result.data, function(index, val) {
										...
										var item=[
												...
												'<button type="button" class="btn btn-primary mr-1" data-toggle="modal" data-target=".banner-details-modal" data-modal-title="'+METLANG.editor+'" data-modal-size="xl" data-modal-url="'+edit_dataurl+val.id+'" data-modal-fullheight="1" data-modal-height100="1" data-modal-tablerefresh="'+table_order+'">'+METLANG.editor+'</button>'
												+'<button type="button" class="btn btn-primary mr-1" data-toggle="modal" data-target=".banner-button-modal" data-modal-title="'+METLANG.button+'" data-modal-size="100" data-modal-dialog-style="margin-top:10%;" data-modal-url="'+button_dataurl+val.id+'" data-modal-oktext data-modal-notext="'+METLANG.close+'">'+METLANG.button+'</button>'
												+M.component.btn('del',{del_url:del_url+val.del_url,class:'btn btn-light'})
											];
										data.push(item);
									});
								}
								...
								if(result.data){
									...
									$.each(result.data, function(index, val) {
										...
										var item=[
												...
												M.component.btn('del',{del_url:del_url+val.id,class:'btn btn-light'})
											];
										data.push(item);
									});
								}
