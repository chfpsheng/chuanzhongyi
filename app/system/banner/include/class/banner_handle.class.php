...
class banner_handle extends handle
{
    ...
    public function img_para_handle($banner_img = array())
    {
        ...
        foreach ($banner_img as $key => $val) {
            ...
            $banner_img[$key]['img_title'] = met_safe_html($banner_img[$key]['img_title']);
            $banner_img[$key]['img_title_mobile'] = met_safe_html($banner_img[$key]['img_title_mobile']);
            $banner_img[$key]['img_des'] = met_safe_html($banner_img[$key]['img_des']);
            $banner_img[$key]['img_des_mobile'] = met_safe_html($banner_img[$key]['img_des_mobile']);
