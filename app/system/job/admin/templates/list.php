...
<include file="pub/content_list/head"/>
		...
		<include file="pub/content_list/tfoot_common"/>
					<div class="float-right">
						...
						<a href="{$url.own_name}c={$class_name}&a=doexportList&class1={$data.class1}&class2={$data.class2}&class3={$data.class3}" data-href="{$url.own_name}c={$class_name}&a=doexportList&class1={$data.class1}&class2={$data.class2}&class3={$data.class3}" class="btn btn-outline-primary ml-2 btn-job-export">{$word.feedbackTip2}</a>
					</div>
				</th>
			</tr>
		</tfoot>
