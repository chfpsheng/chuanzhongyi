...
class job_manage extends message_admin
{
    ...
    public function dojson_list()
    {
        ...
        $list = $this->getJsonList($class1, $class2, $class3, $keyword, $search_type, $orderby_hits, $orderby_updatetime, $jobid);
    ...
    public function getJsonList($class1 = '', $class2 = '', $class3 = '', $keyword = '', $search_type = '', $orderby_hits = '', $orderby_updatetime = '', $jobid = '')
    {
        global $_M;
        //栏目访问权限
     ...
     * @param null $recycle
     */
    public function del_list($id = '', $recycle = null)
    {
        global $_M;
...
//        $redata['list']['met_cv_job_tel'] = $conlum_configs['met_cv_job_tel'];  //短信通知号码
    ...
    {
        global $_M;
        $class123 = $class123 = $_M['class']['column_label']->get_class123_no_reclass($classnow);
