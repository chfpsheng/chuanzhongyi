...
<button type="button" class="btn btn-outline-666 btn-add" table-addlist="#{$table_addlist}" data-table-newid='1'><i class="fa fa-plus-circle"></i> {$word.online_addkefu_v6}</button>
