...
<div class="met-seo">
    <form method="POST" action="{$url.site_admin}?n=html&c=html&a=doSaveSetup" class="static-form"
        ...
        <div class="metadmin-fmbx">
            ...
            <dl>
                ...
                <dd>
                    <div class="form-group clearfix">
                        ...
                        <div class="custom-control custom-radio ">
                            <input type="radio" name="met_webhtm" value="3" class="custom-control-input" id="met_webhtm-3" />
                            <label class="custom-control-label" for="met_webhtm-3">
                                {$word.sethtmlmix}
                                <button type="button" class='btn btn-primary hide' data-toggle="modal" data-target=".staticpage-rules-modal">{$word.pseudo_static}</button>
                            </label>
                        </div>
                        <span class="text-help ml-2">{$word.setbasicTip4}</span>
                        <div class="hide met_webhtm">
                            <a class="btn btn-primary" tabindex="1" data-toggle="modal" data-target=".staticpage-html-modal"
            ...
            <dl>
                <dt>
                    <label class="form-control-label">{$word.sethtm_auto}</label>
                </dt>
                <dd>
                    <div class="form-group clearfix">
                        <div class="custom-control custom-radio ">
                            <input type="radio" name="met_html_auto" value="0" class="custom-control-input" id="met_html_auto-0" />
                            <label class="custom-control-label" for="met_html_auto-0">{$word.close}</label>
                        </div>
                        <div class="custom-control custom-radio ">
                            <input type="radio" name="met_html_auto" value="1" class="custom-control-input" id="met_html_auto-1" />
                            <label class="custom-control-label" for="met_html_auto-1">{$word.sethtm_auto_daily}</label>
                        </div>

                        <div class="custom-control custom-radio ">
                            <input type="radio" name="met_html_auto" value="2" class="custom-control-input" id="met_html_auto-2" />
                            <label class="custom-control-label" for="met_html_auto-2">{$word.sethtm_auto_weekly}</label>
                        </div>

                        <div class="custom-control custom-radio ">
                            <input type="radio" name="met_html_auto" value="3" class="custom-control-input" id="met_html_auto-3" />
                            <label class="custom-control-label" for="met_html_auto-3">{$word.sethtm_auto_monthly}</label>
                        </div>
                        <span class="text-help ml-2">{$word.sethtm_auto_tips}</span><br>
                        <span class="text-help ml-2">{$word.sethtm_auto_tips1}</span>
                    </div>
                </dd>
            </dl>
