...
<div class="met-anchor-list">
  ...
  <button type="button" class="btn btn-outline-666 btn-add" >
    {$word.anchor_textadd}
  </button>
    ...
    <tfoot>
      <tr class="tr-add">
        ...
        <th colspan="6" data-no_column_defs class="btn_group">
          <button type="submit" class="btn btn-primary px-4 mr-2 btn-save">
            {$word.Submit}
          </button>
          <button type="button" class="btn px-4 btn-light btn-delete-all">
            {$word.delete}
          </button>
        </th>
      </tr>
