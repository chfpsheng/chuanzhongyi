...
<div class="d-flex justify-content-between">
    <div>
        <button type="button" class="btn btn-outline-666" data-toggle="modal" data-target=".tags-edit-modal" data-modal-url="tags/edit/?c=index&a=doGetParentColumns" data-modal-title="{$word.mobiletips3}">{$word.add_tag}</button>
    </div>
    <div>
        <!-- 筛选 -->
