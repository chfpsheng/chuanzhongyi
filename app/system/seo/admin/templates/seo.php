            ...
            <dd>
                <div class='form-group'>
                    <div class="custom-control custom-radio ">
                        <input type="radio" name="met_title_type" value='0' class="custom-control-input met_title_type-0" id="met_title_type-0" />
                        <label class="custom-control-label" for="met_title_type-0">{$word.setseotitletype1}</label>
                    </div>
                    <div class="custom-control custom-radio ">
                        <input type="radio" name="met_title_type" value='1' class="custom-control-input met_title_type-1" id="met_title_type-1" />
                        <label class="custom-control-label" for="met_title_type-1">{$word.setseotitletype3}</label>
                    </div>
                    <div class="custom-control custom-radio ">
                        <input type="radio" name="met_title_type" value='2' class="custom-control-input met_title_type-2" id="met_title_type-2" />
                        <label class="custom-control-label" for="met_title_type-2">{$word.setseotitletype2}</label>
                    </div>
                    <div class="custom-control custom-radio ">
                        <input type="radio" name="met_title_type" value='3' class="custom-control-input met_title_type-3" id="met_title_type-3" />
                        <label class="custom-control-label" for="met_title_type-3">{$word.setseotitletype4}</label>
                    </div>
                    <!--内容标题+所属栏目名称+网站名称-->
                    <div class="custom-control custom-radio ">
                        <input type="radio" name="met_title_type" value='4' class="custom-control-input met_title_type-4" id="met_title_type-4" />
                        <label class="custom-control-label" for="met_title_type-4">{$word.setseotitletype5}</label>
                    </div>
