...
class datatools extends admin
{
    ...
    public function doIndex()
    {
        ...
        echo "
        <a href='{$_M['url']['site_admin']}?n=databack&c=datatools&a=doIndex&action=sqldata'>系统数据库指纹</a><br>
        <a href='{$_M['url']['site_admin']}?n=databack&c=datatools&a=doIndex&action=langdata'>系统语言指纹</a><br>
        <a href='{$_M['url']['site_admin']}?n=databack&c=datatools&a=doIndex&action=configdata'>配置库指纹</a><br>
        ";
