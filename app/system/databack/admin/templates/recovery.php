        ...
        <form action="javascript:;">
            <table class="dataTable table table-hover w-100" id="recovery-table"
                ...
                <tr>
                    ...
                    <th width="150" data-table-columnclass="text-center">{$word.webupate6}</th>
                    <th width="150"data-table-columnclass="text-center">{$word.database_type}</th>
                    <th data-table-columnclass="text-center">{$word.setdbsysver}</th>
                    <th data-table-columnclass="text-center">{$word.setdbFilesize}</th>
                    <th width="200" data-table-columnclass="text-center">{$word.setdbTime}</th>
                    <th width="100" data-table-columnclass="text-center">{$word.setdbNumber}</th>
                    <th width="400" data-table-columnclass="text-center">{$word.operate}</th>
                </tr>
                </thead>
                <tbody>
                <?php $colspan=9; ?>
                ...
                <tfoot>
                <tr>
                    <th colspan="{$colspan}" data-no_column_defs class="btn_group">
