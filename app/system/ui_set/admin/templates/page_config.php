...
<form action="{$url.own_name}c=index&a=doset_page_config&classnow={$data.classnow}&id={$data.id}" data-submit-ajax="1">
	<div class="metadmin-fmbx">
		...
		<dl>
			...
			<dd class="form-group">
				<input type="text" name="tab_name_0" value="{$data.tab_name.0}" required class="form-control">
			</dd>
		</dl>
		<dl>
			<dt>
			...
			<dd class="form-group">
				<input type="text" name="tab_name_1" value="{$data.tab_name.1}" required class="form-control">
			</dd>
		</dl>
		<dl>
			<dt>
			...
			<dd class="form-group">
				<input type="text" name="tab_name_2" value="{$data.tab_name.2}" required class="form-control">
			</dd>
		</dl>
		<dl>
			<dt>
			...
			<dd class="form-group">
				<input type="text" name="tab_name_3" value="{$data.tab_name.3}" required class="form-control">
			</dd>
		</dl>
		<dl>
			<dt>
			...
			<dd class="form-group">
				<input type="text" name="tab_name_4" value="{$data.tab_name.4}" required class="form-control">
			</dd>
		</dl>
		</if>
		</if>
