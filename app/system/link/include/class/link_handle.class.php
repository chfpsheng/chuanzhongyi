...
class link_handle extends handle
{
    ...
    public function one_para_handle($link = array())
    {
        ...
        $link['webname'] = htmlspecialchars($link['webname'], ENT_QUOTES, 'UTF-8');
        $link['weburl'] = htmlspecialchars($link['weburl'], ENT_QUOTES, 'UTF-8');
        $link['info'] = htmlspecialchars($link['info'], ENT_QUOTES, 'UTF-8');
        $link['contact'] = htmlspecialchars($link['contact'], ENT_QUOTES, 'UTF-8');
        return $link;
    }
