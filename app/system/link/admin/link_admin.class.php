...
class link_admin extends admin
{
    ...
    public function doGetList()
    {
        ...
        foreach ($group_data as $key => $value) {
            ...
            $group_data[$key]['webname'] = htmlspecialchars($value['webname'], ENT_QUOTES, 'UTF-8');
            $group_data[$key]['weburl'] = htmlspecialchars($value['weburl'], ENT_QUOTES, 'UTF-8');
            $group_data[$key]['info'] = htmlspecialchars($value['info'], ENT_QUOTES, 'UTF-8');
            $group_data[$key]['contact'] = htmlspecialchars($value['contact'], ENT_QUOTES, 'UTF-8');
        }
