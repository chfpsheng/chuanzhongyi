...
?>
<form method="POST" action="{$url.own_name}c=email&a=doSaveEmail"  class='met-email-set-form' data-submit-ajax='1'>
	...
	<dl>
		...
		<dl>
			<dt></dt>
			<dd>
				<button  type="submit" class='btn btn-default btn-test-email' data-url="{$url.own_name}c=email&a=doTestEmail">{$word.upfiletips16}</button>
