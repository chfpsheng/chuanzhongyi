...
$met_fd_sms_check_name='met_'.$filed_name.'_sms_check';
$met_fd_sms_check=$data['list'][$met_fd_sms_check_name];
?>
...
<dd>
    <input type="text" name="{$met_fd_to_name}" value='{$met_fd_to}' data-plugin="tokenfield" data-delimiter="|" class="form-control">
...
<dl>
    ...
    <dd>
        <input type="text" name="{$met_fd_admin_tel_name}" value='{$met_fd_admin_tel}' data-plugin="tokenfield" data-delimiter="|" class="form-control">
        <span class="text-help ml-2">{$word.fdincTip9}</span>
    </dd>
</dl>
...
<dl>
    ...
    <dd>
        <input type="checkbox" data-plugin="switchery" name="{$met_fd_back_name}" value='{$met_fd_back}' data-checked='1' hidden>
...
$editor=array(
    ...
    'no_title'=>1,
    'name'=>$met_fd_content_name,
    'height'=>300,
    'value'=>$met_fd_content
);
?>
<include file="pub/content_details/editor"/>
<h3 class='example-title border-none'>
    {$word.feedbackautosms}
    <a href="#/app/met_sms" target="_blank" class="btn btn-default ml-4 py-2"><i class="wb-chat-text font-size-18 position-relative" style="top: 2px;"></i> {$word.smsApiSetTips}</a>
</h3>
<dl>
    <dt>
    ...
    <dd>
        <input type="checkbox" data-plugin="switchery" name="{$met_fd_sms_back_name}" value='{$met_fd_sms_back}' data-checked='1' hidden>
...
<dl>
    ...
    <dd>
        <input type="checkbox" data-plugin="switchery" name="{$met_fd_sms_check_name}" value='{$met_fd_sms_check}' data-checked='1' hidden>
