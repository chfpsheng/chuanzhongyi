...
?>
<if value="$head_tab">
<nav class="nav nav-underline met-headtab position-sticky oxa flex-nowrap text-nowrap met-scrollbar scrollbar-grey <if value="$head_tab_ajax && !$no_bg">metadmin-content-min py-2 px-4<else/>mb-3</if> bg-white" <if value="$head_tab_ajax">data-ajaxchange='1'</if> <if value="$head_tab_reload">data-reload="1"</if>>
	<list data="$head_tab" name="$v">
	  <a
		...
		<if value="$v['noreload']">data-noreload="1"</if>
		<if value="$v['noloader']">data-noloader="1"</if>
