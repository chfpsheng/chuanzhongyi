...
<dl>
	...
	<dd>
		<div class='form-group clearfix'>
			<div class="d-inline-block file-input-wrapper <if value="!$upload['auto_w']">fixw</if> mr-2">
				<input type="file" name="{$upload.name}" value="{$upload.value}"
				data-plugin='fileinput'
				<if value="$upload['url']">data-url="{$upload.url}"</if>
