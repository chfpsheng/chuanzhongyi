...
<h3 class='example-title clearfix'>
	<span class="my-1 d-inline-block" role="button" data-toggle="collapse" data-target=".{$data.n}-details-seo">SEO {$word.seting}<i class="icon fa-angle-right ml-2"></i></span>
	<!-- <button type="button"
		class="btn btn-outline-primary btn-sm float-right mt-1 seo-ai-generate-btn"
		data-seo-selector=".{$data.n}-details-seo">
