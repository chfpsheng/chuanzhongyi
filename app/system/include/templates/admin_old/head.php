...
$_M['form']['pageset']=1;
$jsrand=str_replace('.','',$_M['config']['metcms_v']).$_M['config']['met_patch'].'_'.intval(time()/1000);
...
<meta name="generator" content="MetInfo V{$_M['config']['metcms_v']}" data-variable="{$_M['url']['site']}|{$_M['lang']}||||{$_M['config']['met_skin_user']}">
<link href="{$_M['url']['site']}favicon.ico" rel="shortcut icon" type="image/x-icon">
<link rel="stylesheet" href="{$_M['url']['public_third']}admin_old/bootstrap/bootstrap.min.css?{$jsrand}">
<link rel="stylesheet" href="{$_M['url']['public_admin_old']}css/metinfo.css?{$jsrand}">
<link rel="stylesheet" href="{$_M['url']['public']}fonts/metinfo-icon1/metinfo-icon1.min.css?{$jsrand}">
<script>
var langtxt = {
		"jsx15":"{$_M['word']['jsx15']}",
		"js35":"{$_M['word']['js35']}",
...
<!--['if IE']><script src="{$_M['url']['public_third']}']}html5shiv/html5shiv.min.js" type="text/javascript"></script><!['endif']-->
</head>
<body>
<!--
EOT;
