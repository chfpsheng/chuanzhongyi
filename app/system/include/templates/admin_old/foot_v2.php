...
$basic_js_time = filemtime(PATH_PUBLIC_THIRD.'web/basic.js');
$metinfo_admin_js_time = filemtime(PATH_PUBLIC_WEB.'js/metinfo_admin.js');
...
<script src="{$url.public_third}web/basic.js?{$basic_js_time}"></script>
<script src="{$url.public_web}js/metinfo_admin.js?{$metinfo_admin_js_time}"></script>
