...
$basic_css_filemtime = filemtime(PATH_PUBLIC_THIRD.'web/basic.css');
$metinfo_admin_css_filemtime = filemtime(PATH_PUBLIC_WEB.'css/metinfo_admin.css');
?>
<!DOCTYPE HTML>
...
<meta name="generator" content="MetInfo V{$c.metcms_v}" data-variable="{$url.site}|{$_M['lang']}|{$c.met_skin_user}||||">
<link href="{$url.site}favicon.ico" rel="shortcut icon" type="image/x-icon">
<link href="{$url.public_third}web/basic.css?{$basic_css_filemtime}" rel='stylesheet' type='text/css'>
<link href="{$url.public_web}css/metinfo_admin.css?{$metinfo_admin_css_filemtime}" rel='stylesheet' type='text/css'>
<?php
