            ...
            if (modal.length === 0) {
                $('body').append(
                  M.component.modalFun({
                    ...
                    modalFooter: `<div class='text-danger tips d-inline-block'>请先仔细阅读安装提示，<span class="tips-scroll">将滚动条滚至底部，</span><span class="tips-other">并等待<span class="update-warning-modal-countdown"></span>秒后</span>方可点击${METLANG.databackup3}、${METLANG.databackup4}或${METLANG.appinstall}</div><button type="button" class="btn btn-default mr-2" data-dismiss="modal">${METLANG.cancel}</button>
