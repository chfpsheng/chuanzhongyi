...
<section class="subcolumn_nav_met_m1156_4_57 column-side <?php echo $ui['navcenter'];?>" m-id="<?php echo $ui['mid'];?>" m-type="head_nav">
...
<?php } ?>
        ...
        <?php
            ...
            $ui['has'] =$parse->list_page_config($met_page);
        ?>
<section class="job_list_page_met_m1156_5_25 lazy" m-id="<?php echo $ui['mid'];?>"   <?php if($ui["bgimg"] && !strstr($ui["bgimg"],$c["met_agents_img"])){ ?>data-background="<?php echo $ui['bgimg'];?>"<?php } ?>>
