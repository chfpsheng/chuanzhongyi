 ...
 * 实现位置：ui/product_list_detail/met_m1156_7/index.php（本页通过下方  引入，
 * 该 <ui> 在编译时会把 UI 文件内容内联进本页的编译缓存，故只要本文件比缓存新就会整页重新编译）。
 */
?>
<?php $met_page = "showproduct";?><?php
...
<?php } ?>
  ...
  <?php if($ui['ui_show']){ ?>
  <?php if($data['classnow']<>10001){ ?>
<section class="location_met_m1156_7_32_main met-content animsition"
  ...
  <div class="container">
    <div class="row">
      <div class="  <?php if($ui["has"]["sidebar"]){ ?>col-lg-9<?php }else{ ?>col-lg-12<?php } ?> met-cons">
        <div class="location_met_m1156_7_32 met-position  pattern-show" m-id="<?php echo $ui['mid'];?>" m-type="nocontent">
          <div class="container">
            <div class="row">
...
<section class="location_met_m1156_7_32" m-id="<?php echo $ui['mid'];?>" m-type="nocontent" 
...
<?php } ?>
        ...
        <?php
            $id = 33;
            $panrent_name = 'product_list_detail';
            $style = 'met_m1156_7';
            $skin_name = 'm1156ui010';
            if(!isset($parse)){
                include_once PATH_ALL_APP . 'met_template/include/class/parse.class.php';
...
<section class="product_list_detail_met_m1156_7_33_main met-content animsition lazy" 
...
<?php } ?> 
        ...
        <div class="product_list_detail_met_m1156_7_33 page met-showproduct pagetype<?php echo $ui['pagetype'];?>" m-id="<?php echo $ui['mid'];?>">
...
<?php } ?>
        ...
        ?> 
  <?php if($ui['ui_show']){ ?>
      <div class="sidebar_met_m1156_7_34 col-lg-3 met-conx" m-id="<?php echo $ui['mid'];?>" m-type="nocontent">
...
<?php }else if($_GET['pageset']){ ?>
<section class="sidebar_met_m1156_7_34" m-id="<?php echo $ui['mid'];?>" m-type="nocontent" 
  style="background:#263238;max-height:40px;text-align:center;color:#fff;line-height:40px;display:block;border-bottom:1px solid #888;">
  该栏目设置了侧边栏隐藏，可在“侧边栏配置”中设置显示（该文字仅“可视化”模式下可见）
</section>
<?php } ?>
