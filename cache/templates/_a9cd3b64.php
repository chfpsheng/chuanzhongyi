        ...
        <div class="row">
            <div class="col-lg-12 met-cons">
                <div class="met-shownews-header">
                    ...
                    <div class="info">
                        <span><i class="fa fa-calendar"></i><?php echo $data['updatetime'];?></span>
                        <span><i class="icon wb-eye"></i><?php echo $data['hits'];?></span>
                          <?php if($data['yiguan_name']){ ?>
                        <span><i class="fa fa-hospital-o"></i>所属医馆：<a href="<?php echo $data['yiguan_url'];?>" title="<?php echo $data['yiguan_name'];?>"><?php echo $data['yiguan_name'];?></a></span>
                        <?php } ?>
                    </div>
                </div>
