  ...
  <div class="container">
    <div class="row">
      <div class="  <?php if($ui["has"]["sidebar"]){ ?>col-lg-9<?php }else{ ?>col-lg-12<?php } ?> met-cons">
        <div class="location_met_m1156_7_14 met-position  pattern-show" m-id="<?php echo $ui['mid'];?>" m-type="nocontent">
          <div class="container">
            <div class="row">
...
<section class="location_met_m1156_7_14" m-id="<?php echo $ui['mid'];?>" m-type="nocontent" 
...
<section class="show_met_m1156_7_20_main met-content animsition" 
  data-background="  <?php if($ui["bgok"]){ ?><?php echo $ui['bgimg'];?><?php } ?>">
  <div class="container">
    <div class="row">
      <div class="  <?php if($ui["has"]["sidebar"]){ ?>col-lg-9<?php }else{ ?>col-lg-12<?php } ?> met-cons">
<?php } ?> 
        ...
        <div class="show_met_m1156_7_20" m-id="<?php echo $ui['mid'];?>">  
...
<?php } ?>
        ...
        ?> 
  <?php if($ui['ui_show']){ ?>
      <div class="sidebar_met_m1156_7_11 col-lg-3 met-conx" m-id="<?php echo $ui['mid'];?>" m-type="nocontent">
...
<?php }else if($_GET['pageset']){ ?>
<section class="sidebar_met_m1156_7_11" m-id="<?php echo $ui['mid'];?>" m-type="nocontent" 
  style="background:#263238;max-height:40px;text-align:center;color:#fff;line-height:40px;display:block;border-bottom:1px solid #888;">
  该栏目设置了侧边栏隐藏，可在“侧边栏配置”中设置显示（该文字仅“可视化”模式下可见）
</section>
<?php } ?>
