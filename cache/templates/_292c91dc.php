        ...
        <div class="row">
            <div class="col-lg-12 met-cons">
                <div class="met-news-list news-lists" m-id="noset">
                    <ul class="met-page-ajax met-pager-ajax" data-scale='<?php echo $c['met_activityimg_y'];?>x<?php echo $c['met_activityimg_x'];?>'>
                        <?php
    $cid = 0;
    if($cid == 0){
        $cid = $data['classnow'];
    }
    $num = $c['met_activity_list'];
    $order = "no_order";
    $activity = load::sys_class('label', 'new')->get('activity');
    $activity->page_num = $num;
    $result = $activity->get_list_page($cid, $data['page']);
    $sub = is_array($result) ? count($result) : 0;
     foreach($result as $index=>$v):
        $v['sub']      = $sub;
        $v['_index']   = $index;
...
?>
                        <li>
                            ...
                            <a class="img" href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                                <img src="<?php echo thumb($v['imgurl'],$c['met_activityimg_x'],$c['met_activityimg_y']);?>" alt="<?php echo $v['title'];?>">
                            </a>
                            <?php } ?>
                            <h4>
                            ...
                            <p class="info">
                                <span><i class="fa fa-calendar"></i><?php echo $v['updatetime'];?></span>
                                <span><i class="icon wb-eye"></i><?php echo $v['hits'];?></span>
                            </p>
                            <p class="des"><?php echo $v['description'];?></p>
                        </li>
                        <?php endforeach;?>
                    </ul>
