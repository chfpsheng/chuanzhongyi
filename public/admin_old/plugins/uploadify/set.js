...
define(function(require, exports, module) {
	...
	var common = require('common');
		require('third/admin_old/uploadify/jquery.form');
	...
	function upHandle(o,d,lval,cval){ //处理回传值
		...
		if(listval)listval.val(o.path);
		if(contentval)contentval.val(o.path);
	}
	...
	function upload(d) { //上传
		...
		url = basepath + 'index.php?c=uploadify&m=include&a='+d.attr('data-upload-type')+'&lang='+lang+'&type=1';
