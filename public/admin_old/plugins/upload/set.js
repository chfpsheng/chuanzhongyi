...
define(function(require, exports, module) {
	...
	//上传组件
	function imgupload(){
		require.async('third/admin_old/upload/webuploader.min',function(){
			var uploader = WebUploader.create({
				auto: true,
				swf: siteurl + 'public/third-party/admin_old/upload/Uploader.swf',
	...
	function imglistloadFun(img_paths,name){
		...
		require('third/admin_old/upload/jPages.css');
		require.async('third/admin_old/upload/jPages.min',function(){
	...
	exports.func = function(e){
		...
		if(tf){
			require.async('epl/uploadify/set',function(a){
				a.func(e);
			});
		}
		if(ik){
			/*拖曳排序*/
			require.async('third/dragsort/jquery.dragsort',function(){
