 ...
 * MetInfo modified based on version 2.2.1
 */
...
seajs.config({
    paths: {
        ...
        'epl': pubjspath + 'plugins',
        'plugins': siteurl + 'public/plugins',
        'third': siteurl + 'public/third-party',
        'web_plugins': siteurl + 'public/third-party/web',
        'own': own.substring(0, own.length - 1),
        'own_tem': own_tem.substring(0, own_tem.length - 1),
        'tem': own_tem.substring(0, own_tem.length - 1),
        'edturl':siteurl+(editorname=='editormd'? 'app/app/editorswith/':'public/third-party/')+editorname,
        'siteurl':siteurl.substring(0, siteurl.length - 1),
        '..':siteurl.substring(0, siteurl.length - 1),
    },
    alias: {
        "jquery": 'third/admin_old/jquery/jquery.js',
