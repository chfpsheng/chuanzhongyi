 ...
 * MetInfo modified based on version 4.1.2
 */
                    ...
                    +'<div class="pswp__scroll-wrap">'
                        ...
                        +'<div class="pswp__ui pswp__ui--hidden">'
                            +'<div class="pswp__top-bar">'
                                ...
                                // +'<button class="pswp__button pswp__button--rotate-left" title="Rotate counterclockwise"><i class="icon md-rotate-ccw" aria-hidden="true"></i></button>'
                                // +'<button class="pswp__button pswp__button--rotate-right" title="clockwise rotation"><i class="icon md-rotate-cw" aria-hidden="true"></i></button>'
