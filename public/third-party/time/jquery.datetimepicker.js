 ...
 * MetInfo modified based on version 2.1.9
 */
 (function( $ ) {
	'use strict'
	var default_options  = {
		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+options.className+'"></div>'),
					...
					mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><div><span></span><i class="fa-sort-down"></i></div></div><div class="xdsoft_label xdsoft_year"><div><span></span><i class="fa-sort-down"></i></div></div><button type="button" class="xdsoft_next"></button></div>'),
				...
				//constructor lego
				mounth_picker
					.find('.xdsoft_month div')
						.after(monthselect);
				mounth_picker
					.find('.xdsoft_year div')
						.after(yearselect);

				mounth_picker
					.find('.xdsoft_month,.xdsoft_year')
						.on('mousedown.xdsoft',function(event) {
							$(this).siblings('.xdsoft_label').find('.xdsoft_select').hide();
