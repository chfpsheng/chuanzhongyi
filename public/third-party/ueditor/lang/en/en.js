...
UE.I18N['en'] = {
    ...
    'insertimage':{
        'static':{
            ...
            'lang_lockicon':"Lock the Proportion"
        },
        ...
        'dragImage': 'Drag and drop pictures to change order.',
    ...
    anchor:{
        'static':{
            ...
            'lang_input_anchorTip':'After adding an anchor at the position edited by the cursor, an identification image will be displayed at the anchor position, and a hyperlink can be added in the editor in the format of # anchor name. For example, if an anchor name is added: aaa, a hyperlink can be added as: # aaa.',
            'lang_input_anchorTip1':'The anchor image will not be displayed in the foreground, but the anchor still exists. Clicking a hyperlink in the foreground will redirect to the location of the anchor.'
        }
    },
    'charts':{
        'static':{
    ...
    map:{
        'static':{
            ...
            auth_tips:"To insert a dynamic map, please obtain Baidu Maps <a href='https://lbsyun.baidu.com/cashier/auth' target='_blank' style='color:red;'>Commercial Authorization</a> first.<div>If authorized, please fill in the <input id='api_key' type='text' value='' placeholder='developer key' style='width:100px;'/> before inserting the dynamic map, otherwise it will be an unauthorized map.</div>"
        },
