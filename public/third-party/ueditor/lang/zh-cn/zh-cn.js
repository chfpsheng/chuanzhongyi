 ...
 * User: taoqili
 * @Date：2023-11-09 11:20:51
 * 修改：米拓企业建站系统 长沙米拓信息技术有限公司 (https://www.metinfo.cn).
...
UE.I18N['zh-cn'] = {
    ...
    'insertimage':{
        ...
        'errorLoadConfig': /*'后端配置项没有正常加载，上传插件不能正常使用！'*/'前台编辑器不支持上传图片和在线管理！',
        ...
        'lockicon':"锁定比例",
        'remoteLockError':"宽高设置形式不正确,不能锁定比例",
    ...
    'insertvideo':{
        ...
        'default':"默认",
        'block':"独占一行",
        'urlError':"输入的视频地址有误或无法解析，请检查后再试！",
        'loading':" &nbsp;视频加载中，请等待……",
        'clickToSelect':"点击选中",
        'goToSource':'访问源视频',
    ...
    'anchor':{
        'static':{
            ...
            'lang_input_anchorTip':'在光标编辑的位置添加锚点后，锚点位置会显示标识图片，之后可在编辑器里添加超链接，超链接格式：#锚点名字。例如添加了锚点名字：aaa，则可添加超链接为：#aaa。',
            'lang_input_anchorTip1':'锚点图片在前台不会显示但锚点仍存在，前台点击超链接会跳转至锚点所在位置。'
        }
    },
    'charts':{
        'static':{
    ...
    'map':{
        'static':{
            ...
            auth_tips:"如需插入动态地图，请先获得百度地图 <a href='https://lbsyun.baidu.com/cashier/auth' target='_blank' style='color:red;'>商用授权</a>。<div>如已获得授权，请填写 <input id='api_key' type='text' value='' placeholder='开发者密钥' style='width:100px;'/> 后再插入动态地图，否则为未授权地图。</div>"
        },
        cityMsg:"请选择城市",
        errorMsg:"抱歉，找不到该位置！"
    },
