            ...
            <div class="col-md-9 met-news-body">
                <div class="row">
                    <div class="met-news-list met-news" m-id="noset">
                        ...
                        <tag action='doctor.list' num="$c['met_doctor_list']" cid="$data['classnow']"></tag>
                        <if value="$sub">
                            <ul class="ulstyle met-pager-ajax imagesize" data-scale='{$c.met_doctorimg_y}x{$c.met_doctorimg_x}'>
                                <include file='ajax/doctor'/>
                            </ul>
                        <else/>
