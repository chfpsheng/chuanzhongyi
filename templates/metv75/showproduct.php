...
<main class="met-showproduct pagetype1 animsition" m-id="product_bar">
    <div class="met-showproduct-head page-content block-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class='met-showproduct-list fngallery cover text-xs-center <if value="count($data['displayimgs']) gt 1">slick-dotted</if>' id='met-imgs-slick' m-id='noset' m-type='displayimgs'>
