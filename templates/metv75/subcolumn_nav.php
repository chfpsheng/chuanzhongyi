...
<div class="met-column-nav" m-id='subcolumn_nav' m-type='nocontent'>
	<div class="container">
		<div class="row">
			<div class="clearfix">
				...
				<if value="$m['module'] neq 1 && $lang['all']">
					<li>
						<a href="{$m.url}"  title="{$lang.all}" {$m.urlnew} {$m.nofollow}
					...
					<if value="$m['isshow']">
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu animation-slide-bottom10">
								<if value="($m['module'] eq 1 ? $m['isshow']:1) && $lang['all']">
									<a href="{$m.url}"  title="{$lang.all}" {$m.nofollow} {$m.urlnew} class='dropdown-item {$m.class}'>{$lang.all}</a>
								</if>
								<tag action='category' cid="$m['id']" type='son' class="active">
		...
		<if value="$lang['product_search'] && $data['module'] eq 3">
