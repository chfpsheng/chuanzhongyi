            ...
            <div class="col-md-9 met-news-body">
                <div class="row">
                    <div class="met-news-list met-news" m-id="noset">
                        ...
                        <tag action='activity.list' num="$c['met_activity_list']" cid="$data['classnow']"></tag>
                        <if value="$sub">
                            <ul class="ulstyle met-pager-ajax imagesize" data-scale='{$c.met_activityimg_y}x{$c.met_activityimg_x}'>
                                <include file='ajax/activity'/>
                            </ul>
                        <else/>
