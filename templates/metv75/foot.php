    ...
    <div class="met-footnav text-xs-center p-b-20" m-id='noset' m-type='foot_nav'>
        <div class="container">
            <div class="row mob-masonry">
                ...
                <!-- 关注我们二维码 -->
                <?php
                $has_footinfo_wx=strstr($lang['footinfo_wx'], 'http') || strstr($lang['footinfo_wx'], 'upload/');
                $has_footinfo_wx2=strstr($lang['footinfo_wx2'], 'http') || strstr($lang['footinfo_wx2'], 'upload/');
                ?>
                <div class="col-lg-3 col-md-6 col-xs-12 info masonry-item" m-type="nocontent">
                    <if value="$lang['aboutus_text'] || $has_footinfo_wx || $has_footinfo_wx2">
                    <if value="$lang['aboutus_text']">
                    <h4 class='font-size-20 m-t-0'>
                        {$lang.aboutus_text}
                    </h4>
                    </if>
                    <div class="erweima row">
                        <if value="$has_footinfo_wx">
                        <div class="imgbox1 col-xs-6">
                            <div class="inline-block text-xs-center">
                                <img src='{$lang.footinfo_wx|thumb:112,112}' alt='{$c.met_webname}'>
                                <if value="$lang['erweima_one']">
                                <p class="weixintext">{$lang.erweima_one}</p>
                                </if>
                            </div>
                        </div>
                        </if>
                        <if value="$has_footinfo_wx2">
                        <div class="imgbox2 col-xs-6">
                            <div class="inline-block text-xs-center">
                                <img src='{$lang.footinfo_wx2|thumb:112,112}' alt='{$c.met_webname}'>
                                <if value="$lang['erweima_two']">
