	...
	slide: function(str){
		switch (str){
			case 1:
				...
				if(METUI['$uicss'].find('.service-slide').length>0){
					 	
					METUI['$uicss_service']=new Swiper('.$uicss .service-box',{
			...
			break;
			case 2:
				if(METUI['$uicss_service']) METUI['$uicss_service'].init();
				METUI['$uicss'].addClass('active');
			break;
			case 3:
				if(METUI['$uicss_service']) METUI['$uicss_service'].destroy(false);
