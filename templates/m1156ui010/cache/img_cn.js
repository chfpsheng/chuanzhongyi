...
METUI_FUN['location_met_m1156_7_17']=METUI['location_met_m1156_7_17_x']={
name: 'location_met_m1156_7_17',
init: function(){
if($('.swiper-header').length==0){
METUI['location_met_m1156_7_17_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['location_met_m1156_7_17_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
$('.location_met_m1156_7_17_main')
.css('background-image','url('+$('.location_met_m1156_7_17_main').attr('data-background')+')')
...
var x=new metui(METUI_FUN['location_met_m1156_7_17']);
METUI_FUN['img_list_page_met_m1156_7_23']=METUI['img_list_page_met_m1156_7_23_x']={
name: 'img_list_page_met_m1156_7_23',
init: function(){
if($('.swiper-header').length==0){
METUI['img_list_page_met_m1156_7_23_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['img_list_page_met_m1156_7_23_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
$('.img_list_page_met_m1156_7_23_main')
.css('background-image','url('+$('.img_list_page_met_m1156_7_23_main').attr('data-background')+')')
.removeAttr('data-background')
}
METUI['img_list_page_met_m1156_7_23'].addClass('active');
break;
case 2:
METUI['img_list_page_met_m1156_7_23'].addClass('active');
break;
case 3:
METUI['img_list_page_met_m1156_7_23'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['img_list_page_met_m1156_7_23']);
/*#img_cn.js #米拓企业建站系统 metinfo 8_1 #Copyright (C) 长沙米拓信息技术有限公司 (https://www.metinfo.cn). All rights reserved.*/