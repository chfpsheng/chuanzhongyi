...
METUI_FUN['location_met_m1156_7_32']=METUI['location_met_m1156_7_32_x']={
name: 'location_met_m1156_7_32',
init: function(){
if($('.swiper-header').length==0){
METUI['location_met_m1156_7_32_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['location_met_m1156_7_32_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
$('.location_met_m1156_7_32_main')
.css('background-image','url('+$('.location_met_m1156_7_32_main').attr('data-background')+')')
...
var x=new metui(METUI_FUN['location_met_m1156_7_32']);
METUI_FUN['product_list_detail_met_m1156_7_33']=METUI['product_list_detail_met_m1156_7_33_x']={
name: 'product_list_detail_met_m1156_7_33',
init: function(){
if($('.swiper-header').length==0){
METUI['product_list_detail_met_m1156_7_33_x'].slide(1);
}
if(METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct').hasClass('pagetype2')){
$(window).scroll(function(){
if( METUI['product_list_detail_met_m1156_7_33'].find('.navbar.navbar-default').hasClass('navbar-fixed-top') ){
METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct').addClass('top');
}else{
METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct').removeClass('top');
}
});
}
},
...
var nav=METUI['product_list_detail_met_m1156_7_33'].find("nav.navbar.navbar-default");
...
if(!res) $(window).scroll(function(){ METUI['product_list_detail_met_m1156_7_33_x'].scroll(true); });
},
resize: function(res){
if(METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct.pagetype2 nav.navbar').length>0){
CTop=METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct.pagetype2 nav.navbar').height();
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-container.full').css('padding-top',CTop);
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-container.full .swiper-button-next,.shownews-container.full .swiper-button-prev').css('margin-top',CTop/2-22);
}
if(!res) $(window).resize(function(){ METUI['product_list_detail_met_m1156_7_33_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
...
.css('background-image','url('+$('.product_list_detail_met_m1156_7_33_main').attr('data-background')+')')
.removeAttr('data-background')
}
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide img').each(function(index, element) {
$(this).data('src',$(this).attr('data-src'));
});
shownews_container = new Swiper('.product_list_detail_met_m1156_7_33 .shownews-container',{
...
watchSlidesProgress: true,
watchSlidesVisibility: true,
prevButton: '.product_list_detail_met_m1156_7_33 .swiper-button-prev',
nextButton: '.product_list_detail_met_m1156_7_33 .swiper-button-next',
onSlideChangeStart: function(swiper){
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide-small').removeClass('active').eq(swiper.activeIndex).addClass('active');
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide img').each(function(index, element) {
...
that=METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide img').eq(swiper.activeIndex);
that.attr('src',that.data('src'));
}
});
var shownews_small_length=METUI['product_list_detail_met_m1156_7_33'].find('.shownews-container-small').length;
if(shownews_small_length>0){
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-container-small').css(
'max-width',METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide-small').length*95-15+'px'
);
shownews_container_small = new Swiper('.product_list_detail_met_m1156_7_33 .shownews-container-small',{
...
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-slide-small').removeClass('active').eq(swiper.clickedIndex).addClass('active');
});
}
METUI['product_list_detail_met_m1156_7_33'].find(".met-editor,.shownews-container").wrapInner("<div class='editorlightgallery'></div>");
METUI['product_list_detail_met_m1156_7_33'].find(".met-editor,.shownews-container").each(function() {
var img_gallery_open=1,
this_editor=this;
METUI['product_list_detail_met_m1156_7_33'].find("img",this).one('click',function() {
if(img_gallery_open){
METUI['product_list_detail_met_m1156_7_33'].find('img',this_editor).each(function() {
...
METUI['product_list_detail_met_m1156_7_33'].find('.editorlightgallery',this_editor).galleryLoad();
...
if(METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct.pagetype2 nav.navbar').length>0){
METUI['product_list_detail_met_m1156_7_33'].find('.shownews-container.full').css('padding-top',METUI['product_list_detail_met_m1156_7_33'].find('.met-showproduct.pagetype2 nav.navbar').height());
}
break;
case 2:
break;
...
var x=new metui(METUI_FUN['product_list_detail_met_m1156_7_33']);
/*#showproduct_cn.js #米拓企业建站系统 metinfo 8_1 #Copyright (C) 长沙米拓信息技术有限公司 (https://www.metinfo.cn). All rights reserved.*/