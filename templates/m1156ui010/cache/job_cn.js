...
METUI_FUN['subcolumn_nav_met_m1156_4_57']=METUI['subcolumn_nav_met_m1156_4_57_x']={
name: 'subcolumn_nav_met_m1156_4_57',
IE9: navigator.userAgent.indexOf('MSIE 9.0')>0,
init: function(){
if($('.swiper-header').length==0){
METUI['subcolumn_nav_met_m1156_4_57_x'].slide(1);
}
},
resize: function(res){
if(METUI['subcolumn_nav_met_m1156_4_57'].hasClass('center')){
var column_width=0;
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-nav').removeAttr('style');
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-li').each(function(){
column_width+=$(this).outerWidth();
});
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-nav').css('max-width',column_width);
}
if(!res) $(window).resize(function(){ METUI['subcolumn_nav_met_m1156_4_57_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(METUI['subcolumn_nav_met_m1156_4_57'].find('.column-li').length<=1){
METUI['subcolumn_nav_met_m1156_4_57'].hide();
}
METUI['subcolumn_nav_met_m1156_4_57_column']=new Swiper('.column-nav',{
initialSlide : METUI['subcolumn_nav_met_m1156_4_57'].find('.column-li.active').index(),
...
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-nav').addClass('active');
},
onTouchStart : function(swiper,even){
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-hover ul').removeClass('active');
}
});
if(METUI['subcolumn_nav_met_m1156_4_57'].find('.column-hover').length>0){
var navtime='';
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-li').mouseover(function(){
if(Breakpoints.is('lg')){
clearTimeout(navtime);
var nowleft=$(this).offset().left;
var navul=METUI['subcolumn_nav_met_m1156_4_57'].find('.column-hover ul').removeClass('active').eq($(this).index());
...
METUI['subcolumn_nav_met_m1156_4_57'].mouseleave(function(){
clearTimeout(navtime);
navtime=window.setTimeout(function(){
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-hover ul').removeClass('active');
},200);
});
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-hover ul').mouseenter(function(){
clearTimeout(navtime);
});
METUI['subcolumn_nav_met_m1156_4_57'].find('.column-li a').click(function(e){
if(!Breakpoints.is('lg')&&$(this).parent().hasClass('navs')){
e.preventDefault();
}
});
}
METUI['subcolumn_nav_met_m1156_4_57'].addClass('active');
break;
case 2:
if(METUI['subcolumn_nav_met_m1156_4_57_column']) METUI['subcolumn_nav_met_m1156_4_57_column'].init();
METUI['subcolumn_nav_met_m1156_4_57'].addClass('active');
break;
case 3:
if(METUI['subcolumn_nav_met_m1156_4_57_column']) METUI['subcolumn_nav_met_m1156_4_57_column'].destroy(false);
METUI['subcolumn_nav_met_m1156_4_57'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['subcolumn_nav_met_m1156_4_57']);
METUI_FUN['job_list_page_met_m1156_5_25']=METUI['job_list_page_met_m1156_5_25_x']={
name: 'job_list_page_met_m1156_5_25',
init: function(){
if($('.swiper-header').length==0){
METUI['job_list_page_met_m1156_5_25_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['job_list_page_met_m1156_5_25_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['job_list_page_met_m1156_5_25']
.css('background-image','url('+METUI['job_list_page_met_m1156_5_25'].attr('data-background')+')')
...
var x=new metui(METUI_FUN['job_list_page_met_m1156_5_25']);
/*#job_cn.js #米拓企业建站系统 metinfo 8_1 #Copyright (C) 长沙米拓信息技术有限公司 (https://www.metinfo.cn). All rights reserved.*/