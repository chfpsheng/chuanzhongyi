...
METUI_FUN['column_list_met_m1156_7_2']=METUI['column_list_met_m1156_7_2_x']={
name: 'column_list_met_m1156_7_2',
init: function(){
if($('.swiper-header').length==0){
METUI['column_list_met_m1156_7_2_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['column_list_met_m1156_7_2_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['column_list_met_m1156_7_2']
.css('background-image','url('+METUI['column_list_met_m1156_7_2'].attr('data-background')+')')
.removeAttr('data-background');
}
if(METUI['column_list_met_m1156_7_2'].find('.service-slide').length>0){
METUI['column_list_met_m1156_7_2_service']=new Swiper('.column_list_met_m1156_7_2 .service-box',{
...
METUI['column_list_met_m1156_7_2'].addClass('active');
break;
case 2:
if(METUI['column_list_met_m1156_7_2_service']) METUI['column_list_met_m1156_7_2_service'].init();
METUI['column_list_met_m1156_7_2'].addClass('active');
break;
case 3:
if(METUI['column_list_met_m1156_7_2_service']) METUI['column_list_met_m1156_7_2_service'].destroy(false);
METUI['column_list_met_m1156_7_2'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['column_list_met_m1156_7_2']);
METUI_FUN['show_list_met_m1156_7_3']=METUI['show_list_met_m1156_7_3_x']={
name: 'show_list_met_m1156_7_3',
init: function(){
if($('.swiper-header').length==0){
METUI['show_list_met_m1156_7_3_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['show_list_met_m1156_7_3_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['show_list_met_m1156_7_3']
.css('background-image','url('+METUI['show_list_met_m1156_7_3'].attr('data-background')+')')
.removeAttr('data-background');
}
METUI['show_list_met_m1156_7_3'].addClass('active');
break;
case 2:
METUI['show_list_met_m1156_7_3'].addClass('active');
break;
case 3:
METUI['show_list_met_m1156_7_3'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['show_list_met_m1156_7_3']);
METUI_FUN['product_list_met_m1156_7_4']=METUI['product_list_met_m1156_7_4_x']={
name: 'product_list_met_m1156_7_4',
init: function(){
if($('.swiper-header').length==0){
METUI['product_list_met_m1156_7_4_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['product_list_met_m1156_7_4_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['product_list_met_m1156_7_4']
.css('background-image','url('+METUI['product_list_met_m1156_7_4'].attr('data-background')+')')
.removeAttr('data-background');
}
METUI['product_list_met_m1156_7_4'].addClass('active');
break;
case 2:
METUI['product_list_met_m1156_7_4'].addClass('active');
break;
case 3:
METUI['product_list_met_m1156_7_4'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['product_list_met_m1156_7_4']);
METUI_FUN['img_list_met_m1156_7_5']=METUI['img_list_met_m1156_7_5_x']={
name: 'img_list_met_m1156_7_5',
init: function(){
if($('.swiper-header').length==0){
METUI['img_list_met_m1156_7_5_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['img_list_met_m1156_7_5_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['img_list_met_m1156_7_5']
.css('background-image','url('+METUI['img_list_met_m1156_7_5'].attr('data-background')+')')
.removeAttr('data-background');
}
if(METUI['img_list_met_m1156_7_5'].find('.case-slide').length>0){
METUI['img_list_met_m1156_7_5_case']=new Swiper('.img_list_met_m1156_7_5 .case-box',{
...
METUI['img_list_met_m1156_7_5'].addClass('active');
break;
case 2:
if(METUI['img_list_met_m1156_7_5_case']) METUI['img_list_met_m1156_7_5_case'].init();
METUI['img_list_met_m1156_7_5'].addClass('active');
break;
case 3:
if(METUI['img_list_met_m1156_7_5_case']) METUI['img_list_met_m1156_7_5_case'].destroy(false);
METUI['img_list_met_m1156_7_5'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['img_list_met_m1156_7_5']);
METUI_FUN['news_list_met_m1156_7_6']=METUI['news_list_met_m1156_7_6_x']={
name: 'news_list_met_m1156_7_6',
init: function(){
if($('.swiper-header').length==0){
METUI['news_list_met_m1156_7_6_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['news_list_met_m1156_7_6_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['news_list_met_m1156_7_6']
.css('background-image','url('+METUI['news_list_met_m1156_7_6'].attr('data-background')+')')
.removeAttr('data-background');
}
if(METUI['news_list_met_m1156_7_6'].find('.info-slide').length>0){
METUI['news_list_met_m1156_7_6_info']=new Swiper('.news_list_met_m1156_7_6 .info-box',{
wrapperClass: 'info-wraper',
slideClass: 'info-slide',
slidesPerView: 'auto',
autoplay : 4000,
simulateTouch: METUI['news_list_met_m1156_7_6'].find('.info-slide').length>2?true:false,
watchSlidesProgress : true,
watchSlidesVisibility : true,
observer:true,
observeParents:true
...
METUI['news_list_met_m1156_7_6'].addClass('active');
break;
case 2:
if(METUI['news_list_met_m1156_7_6_info']) METUI['news_list_met_m1156_7_6_info'].init();
METUI['news_list_met_m1156_7_6'].addClass('active');
break;
case 3:
if(METUI['news_list_met_m1156_7_6_info']) METUI['news_list_met_m1156_7_6_info'].destroy(false);
METUI['news_list_met_m1156_7_6'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['news_list_met_m1156_7_6']);
METUI_FUN['case_list_met_m1156_7_7']=METUI['case_list_met_m1156_7_7_x']={
name: 'case_list_met_m1156_7_7',
init: function(){
if($('.swiper-header').length==0){
METUI['case_list_met_m1156_7_7_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['case_list_met_m1156_7_7_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['case_list_met_m1156_7_7']
.css('background-image','url('+METUI['case_list_met_m1156_7_7'].attr('data-background')+')')
.removeAttr('data-background');
}
if(METUI['case_list_met_m1156_7_7'].find('.parent-slide').length>0){
METUI['case_list_met_m1156_7_7_parent']=new Swiper('.case_list_met_m1156_7_7 .parent-box',{
...
METUI['case_list_met_m1156_7_7'].addClass('active');
break;
case 2:
if(METUI['case_list_met_m1156_7_7_parent']) METUI['case_list_met_m1156_7_7_parent'].init();
METUI['case_list_met_m1156_7_7'].addClass('active');
break;
case 3:
if(METUI['case_list_met_m1156_7_7_parent']) METUI['case_list_met_m1156_7_7_parent'].destroy(false);
METUI['case_list_met_m1156_7_7'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['case_list_met_m1156_7_7']);
METUI_FUN['feedback_list_met_m1156_7_8']=METUI['feedback_list_met_m1156_7_8_x']={
name: 'feedback_list_met_m1156_7_8',
init: function() {
$('.feedback_list_met_m1156_7_8 .feedback-form .form-group').each(function() {
...
resize: function(res){
if(!res) $(window).resize(function(){ METUI['feedback_list_met_m1156_7_8_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
METUI['feedback_list_met_m1156_7_8']
.css('background-image','url('+METUI['feedback_list_met_m1156_7_8'].attr('data-background')+')')
.removeAttr('data-background');
}
METUI['feedback_list_met_m1156_7_8'].addClass('active');
break;
case 2:
METUI['feedback_list_met_m1156_7_8'].addClass('active');
break;
case 3:
METUI['feedback_list_met_m1156_7_8'].removeClass('active');
break;
}
}
}
var x=new metui(METUI_FUN['feedback_list_met_m1156_7_8']);
/*#index_cn.js #米拓企业建站系统 metinfo 8_1 #Copyright (C) 长沙米拓信息技术有限公司 (https://www.metinfo.cn). All rights reserved.*/