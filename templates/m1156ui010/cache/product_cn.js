...
METUI_FUN['location_met_m1156_7_16']=METUI['location_met_m1156_7_16_x']={
name: 'location_met_m1156_7_16',
init: function(){
if($('.swiper-header').length==0){
METUI['location_met_m1156_7_16_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['location_met_m1156_7_16_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
$('.location_met_m1156_7_16_main')
.css('background-image','url('+$('.location_met_m1156_7_16_main').attr('data-background')+')')
...
var x=new metui(METUI_FUN['location_met_m1156_7_16']);
METUI_FUN['product_list_page_met_m1156_7_22']=METUI['product_list_page_met_m1156_7_22_x']={
name: 'product_list_page_met_m1156_7_22',
init: function(){
if($('.swiper-header').length==0){
METUI['product_list_page_met_m1156_7_22_x'].slide(1);
}
},
resize: function(res){
if(!res) $(window).resize(function(){ METUI['product_list_page_met_m1156_7_22_x'].resize(true); });
},
slide: function(str){
switch (str){
case 1:
if(!METUI['slide']){
$('.product_list_page_met_m1156_7_22_main')
.css('background-image','url('+$('.product_list_page_met_m1156_7_22_main').attr('data-background')+')')
.removeAttr('data-background')
}
METUI['product_list_page_met_m1156_7_22'].find("img[data-original]").lazyload({
load: function(){
METUI['product_list_page_met_m1156_7_22_x'].view();
}
});
METUI['product_list_page_met_m1156_7_22'].addClass('active');
break;
case 2:
METUI['product_list_page_met_m1156_7_22'].addClass('active');
break;
case 3:
METUI['product_list_page_met_m1156_7_22'].removeClass('active');
break;
}
},
view: function(){
...
var x=new metui(METUI_FUN['product_list_page_met_m1156_7_22']);
function metAnimOnScroll(obj){
window.setTimeout(function(){
$('.product_list_page_met_m1156_7_22 img[data-original]').each(function(index, element) {
...
/*#product_cn.js #米拓企业建站系统 metinfo 8_1 #Copyright (C) 长沙米拓信息技术有限公司 (https://www.metinfo.cn). All rights reserved.*/